...
![](../../R/x86_64-pc-linux-gnu-library/4.5/lorentz/help/figures/lorentz.png)
...
[`install.packages()`](https://rdrr.io/r/utils/install.packages.html) at
the R prompt:
...
Although natural units in which are used by default, this can be
changed.
...
when relativistic effects are included. To combine and in terms of
