...
comm_fail1(u=u, v=v)
@
\caption{Commutative failure\ref{comfail1} in relativity}
  \end{center}
\end{figure}
...
comm_fail2(u=u, v=v)
@
\caption{Commutative failure\ref{comfail2} in relativity}
  \end{center}
\end{figure}
...
@
\caption{Associative law failure\ref{assfail} in relativity}
  \end{center}
\end{figure}
