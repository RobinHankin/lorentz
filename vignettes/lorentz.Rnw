...
<<>>=
boost(u) %*% boost(as.3vel(c(0.2,0.9,0.1)))
@ 
...
In this short vignette I will introduce the \pkg{lorentz} package
which gives functionality for manipulating three-velocities in the
context of their being a gyrogroup.
